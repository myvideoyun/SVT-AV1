...
EbErrorType signal_derivation_me_kernel_oq(
    ...
    if (sequence_control_set_ptr->static_config.enable_subpel) {
        if (picture_control_set_ptr->sc_content_detected)
            if (enc_mode <= ENC_M1)
