...
| **LocalWarpedMotion** | -local-warp | [0/1] | 1 | Enable warped motion use , 0 = OFF, 1 = ON |
| **OBMC** | -obmc | [0/1] | 1 | Enable OBMC, 0 = OFF, 1 = ON |
| **RDOQ** | -rdoq | [0/1] | 1 | Enable RDOQ, 0 = OFF, 1 = ON |
| **Bipred3x3** | -bipred-3x3 | [0-2] | 0 | Set bipred3x3 injection, 0 = OFF, 1 = ON FULL, 2 = Reduced set, -1 = AUTO|
| **PredMe** | -pred-me | [0-5] | 0 | Set predictive me level: <BR>-1 = AUTO<BR>0 = OFF <BR>1 = 7x5 full-pel search + sub-pel refinement off <BR>2 = 7x5 full-pel search +  (H + V) sub-pel refinement only = 4 half-pel + 4 quarter-pel = 8 positions + pred_me_distortion to pa_me_distortion deviation on <BR>3 = 7x5 full-pel search +  (H + V + D only ~ the best) sub-pel refinement = up to 6 half-pel + up to 6  quarter-pel = up to 12 positions + pred_me_distortion to pa_me_distortion deviation on <BR>4 = 7x5 full-pel search +  (H + V + D) sub-pel refinement = 8 half-pel + 8 quarter-pel = 16 positions + pred_me_distortion to pa_me_distortion deviation on <BR>5 = 7x5 full-pel search +  (H + V + D) sub-pel refinement = 8 half-pel + 8 quarter-pel = 16 positions + pred_me_distortion to pa_me_distortion deviation off |
| **CompoundLevel** | -compound | [0-2] | 1 | Set compound mode: <BR>-1 = AUTO<BR>0 = OFF: No compond mode search : AVG only <BR>1 = ON: compond mode search: AVG/DIST/DIFF <BR>2 = ON: AVG/DIST/DIFF/WEDGE |
| **RestorationFilter** | -restoration-filtering | [0/1] | 1 | Enable restoration filtering , 0 = OFF, 1 = ON|
| **Atb** | -atb | [0/1] | 1 | Enable atb , 0 = OFF, 1 = ON|
| **Cdf** | -cdf | [0/1] | 1 | Enable cdf, 0 = OFF, 1 = ON|
| **UpdateCdf** | -updt-cdf | [0/1] | 1 | Enable update cdf, 0 = OFF, 1 = ON|
| **FrameEndCdfUpdate** | -framend-cdf-upd-mode | [0/1] | 1 | Enable frame end cdf update mode, 0 = OFF, 1 = ON|
| **CombineClass12** | -class-12 | [0/1] | 1 | Enable combine MD Class1&2, 0 = OFF, 1 = ON|
| **EdgeSkipAngleIntra** | --intra-edge-skp | [0/1] | 1 | Enable skip angle intra based on edge, 0 = OFF, 1 = ON|
| **InterIntraCompound** | -interintra-comp | [0/1] | 1 | Enable inter intra compound, 0 = OFF, 1 = ON|
| **FractionalSearch64** | -frac-search-64 | [0/1] | 1 | Enable fractional search for 64x64, 0 = OFF, 1 = ON|
| **Mfmv** | -mfmv | [0/1] | 1 | Enable motion field motion vector, 0 = OFF, 1 = ON|
| **QuantFp** | -quantize-fp | [0/1] | 1 | Enable perform quantize fp, 0 = OFF, 1 = ON|
| **RedundantBlock** | -redundant-blk | [0/1] | 1 | Enable redundant block, 0 = OFF, 1 = ON|
| **Trellis** | -trellis | [0/1] | 1 | Enable trellis quant coefficient optimization, 0 = OFF, 1 = ON|
| **SpatialSSEfl** | -spatial-sse-fl | [0/1] | 1 | Enable spatial sse full loop, 0 = OFF, 1 = ON|
| **Subpel** | -subpel | [0/1] | 1 | Enable subpel, 0 = OFF, 1 = ON|
| **OverBoundryBlock** | -over-bndry-blk | [0/1] | 1 | Enable over boundary block mode, 0 = OFF, 1 = ON|
| **NewNearestCombInjection** | -new-nrst-near-comb | [0/1] | 1 | Enable new nearest near comb injection, 0 = OFF, 1 = ON|
| **nx4ParentMvInjection** | -nx4-4xn-mv-inject | [0/1] | 1 | Enable nx4 4xn parent mv injection, 0 = OFF, 1 = ON|
| **PruneUnipredMe** | -prune-unipred-me | [0/1] | 1 | Enable prune unipred at me, 0 = OFF, 1 = ON|
| **PruneRefRecPart** | -prune-ref-rec-part | [0/1] | 1 | Enable prune prune ref frame for rec partitions, 0 = OFF, 1 = ON|
| **NsqTable** | --nsq-table-use | [0/1] | 1 | Enable nsq table, 0 = OFF, 1 = ON|
...
| **ChromaMode** | -chroma | [0-3] | 0 | Chroma Mode <br>0 = Full chroma search @ MD  <br>1 = Fast chroma search @ MD  <br>2 = Chroma blind @ MD + CFL @ EP <br>3 = Chroma blind @ MD + no CFL @ EP |
